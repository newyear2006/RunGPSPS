...
_Automatisch erzeugt aus TCX-Dateien und RunGPS-Metadaten aus `RunGPSData/Trainings.xml`._

## Überblick: alle Aufzeichnungen
...
_Die Highlights beziehen sich auf die Auswertung ohne `Autofahren`, falls solche Einträge vorhanden sind._

| Highlight | Training | Sport | Titel | Datum | Wert |
| --- | --- | --- | --- | --- | --- |
| Längste Strecke | [2868449](../Trainings/2868449.TCX) | Other |  | 2024-08-25 | 835,6 km |
| Längste Dauer | [2474853](../Trainings/2474853.TCX) | Other |  | 2019-12-15 | 58:16:55 |
| Meiste Höhenmeter | [1655870](../Trainings/1655870.TCX) | Other |  | 2015-06-14 | 4.759 m |
| Höchster Punkt | [1655870](../Trainings/1655870.TCX) | Other |  | 2015-06-14 | 4.228 m |
| Schnellste Ø-Geschwindigkeit | [2821491](../Trainings/2821491.TCX) | Other |  | 2023-12-22 | 85,0 km/h |
| Meiste Trackpoints | [2818560](../Trainings/2818560.TCX) | Other |  | 2023-12-03 | 26.729 |
...
| Sport | Trainings | km | Stunden |
| --- | --- | --- | --- |
| Other | 1997 | 38.049,0 | 6.419,4 |
| Biking | 91 | 2.550,3 | 163,6 |
| Running | 74 | 484,0 | 46,6 |

## Grafiken

![Kilometer pro Jahr](charts/km_per_year.png)

![Kilometer pro Monat](charts/km_per_month.png)

![Kumulative Kilometer](charts/cumulative_km.png)

![Trainings pro Wochentag](charts/trainings_by_weekday.png)

![Top 20 längste Trainings](charts/top20_distance.png)

![Kilometer nach Sportart](charts/km_by_sport.png)

## Karten

- [GitHub-Karte: Trainings-Startpunkte](geojson/trainings-overview.geojson)

## Jahresübersicht ohne Autofahren
...
## Top 20 längste Trainings ohne Autofahren

| Training | Datum | Sport | Titel | km | Dauer | Hm+ | Ø km/h |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
- `trainings.csv`: alle erkannten Trainings inklusive RunGPS-Sportart
- `trainings-without-vehicle.csv`: Auswertung ohne `Autofahren`
- `yearly-summary.csv`: Jahreswerte ohne `Autofahren`
- `monthly-summary.csv`: Monatswerte ohne `Autofahren`
- `highlights.json`: maschinenlesbare Zusammenfassung
